...
<body>
	...
	<!-- Table code -->
	<div class="container-fluid">
		<h3 style="text-align: center; margin-top: 50px;"><b>All Customers</b></h3>
		<div class="main">
			<div class="center">
	...
	<footer>
		<p class="p-3 bg-dark text-white text-center" style="margin-top: 150px; margin-bottom: 0px;">Designed by Dhwani Kutmutia <br> <br>Incase of any query you can contact me</p>
	</footer>
